...
//Compile to create class file: javac --source-path myapp -d classes myapp/*
//Run: java -cp classes myapp.HelloWorld
//Packaging to create jar file: jar -c -v -f myapp.jar -e myapp.HelloWorld . (Do classes folder)
//Running the packaged jar file: java -cp classes/myapp.jar myapp.HelloWorld
...
public class HelloWorld {
    ...
    public static void main(String[] args) {
        ...
        // //     System.out.println("the nearest swimming pool is " 
        // //     + "NUS Guild House Swimming Pool");
        ...
        //These 2 ways can sort: the collection and the list. COllection is better way but string also need know
        ...
        //Try creating map with a string of fish prawn fist prawn prok beef and then use map like add ("fish",1) then can create numbers
